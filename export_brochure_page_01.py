...
html_file = os.path.join(current_dir, "pages", "brochure_page_01.html")
html_url = f"file:///{html_file.replace(os.sep, '/')}"

export_dir = os.path.join(current_dir, "exports")
os.makedirs(export_dir, exist_ok=True)

out_png = os.path.join(export_dir, "brochure_page_01.png")
out_pdf = os.path.join(export_dir, "SHIVNETRA47_Brochure_Page_01.pdf")
out_pdf_root = os.path.join(current_dir, "SHIVNETRA47_Brochure_Page_01.pdf")
